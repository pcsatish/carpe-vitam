...
class LabReport(Base):
    ...
    extractor_used: Mapped[str | None] = mapped_column(String(100), nullable=True)  # e.g., "GenericPDFExtractor"
    ...
    test_results = relationship("TestResult", back_populates="lab_report", cascade="all, delete-orphan", lazy="raise")
